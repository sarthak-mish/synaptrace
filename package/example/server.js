 ...
 *
 * Then open:
 *   http://localhost:3000/__pulse/report   → view live dashboard
 *   http://localhost:3000/__pulse/report?format=pdf   → download the PDF report
 *
 * Security demo — protected endpoint:
 *   http://localhost:3000/__pulse/report?secret=demo-secret
 */
...
const server = app.listen(PORT, async () => {
  ...
  console.log(`  → http://localhost:${PORT}/__pulse/report`);
  console.log('\n  Download the PDF report:');
  console.log(`  → http://localhost:${PORT}/__pulse/report?format=pdf\n`);
